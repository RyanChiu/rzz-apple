(function () {
  ...
  const i18n = {
    en: {
      page_title: "RZZ - Lightweight RSS Reader for macOS",
      page_desc: "RZZ is a lightweight RSS reader for macOS with app lock, import/export backup, flexible network settings, and smooth reading.",
      ...
      hero_meta_html: "Distribution channel: GitHub Release + DMG. Requires macOS 14.0 or later.<br />Donation is optional and does not affect feature access.",
      ...
      highlight_network_title: "Flexible Network Settings",
      highlight_network_desc: "Feed fetching and content loading can be configured independently for better network compatibility.",
      ...
      step_1: "Open the downloaded DMG, then drag RZZ.app onto Applications.",
      ...
      support_desc: "Optional support helps cover signing, hosting, compatibility testing, and maintenance.",
    ...
    zh: {
      page_title: "RZZ - 面向 macOS 的轻量 RSS 阅读器",
      page_desc: "RZZ 是轻量 RSS 阅读器，支持 App Lock、导入导出备份、灵活网络设置和流畅阅读。",
      ...
      hero_meta_html: "分发渠道：GitHub Release + DMG。需要 macOS 14.0 或更高版本。<br />Donate 为自愿支持，不影响功能使用。",
      ...
      highlight_network_title: "灵活网络设置",
      highlight_network_desc: "Feed 拉取与正文加载可分别设置网络访问方式，以提升兼容性。",
      core_title: "核心特性",
      ...
      step_1: "打开下载的 DMG，将 RZZ.app 拖到 Applications 中。",
      ...
      support_desc: "自愿支持将用于代码签名、网站托管、兼容性测试和日常维护。",
      support_cta: "支持 RZZ",
